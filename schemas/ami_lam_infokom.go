...
type AmiLamInfokom struct {
	IDLamInfokom     int           `gorm:"primaryKey;column:id_laminfokom" json:"-"`
...
func (m *AmiLamInfokom) TableName() string {
	return "ami_lam_infokom"
}
